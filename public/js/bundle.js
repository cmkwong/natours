...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // for the #id in tour.pug
    style: 'mapbox://styles/cmkwong/cknymzkhy446d17pbsst8jmai',
    scrollZoom: false // center: [-80.185942, 25.774772],
    // zoom: 10,
    // interactive: false

  });
  var bounds = new mapboxgl.LngLatBounds(); // #186-12:00
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' //- this api is from authController
...
var stripe = Stripe('pk_test_51JCxaAJIT6U6VugixsYaz5K5nbj9iDqD1L0uFlYrNW30Njx688aBi7oaPdz6F4zwYm2lvYWoIInoANIR0RMwXFkO00e3ZOq6DU');
...
;
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // update data by API, #195 0800
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // const tourId = e.target.dataset.tourId; // #211 1200

    var tourId = e.target.dataset.tourId; // #211 1200
...
;
var alertMessage = document.querySelector('body').dataset.alert; // dataset.alert is pointing to body on base.pug, #226 3320
